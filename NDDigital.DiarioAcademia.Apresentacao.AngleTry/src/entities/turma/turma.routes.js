(function () {
    ...
    function configRoutes(routes, helper) {
        routes.push({
            ...
            templateUrl: '/src/entities/turma/views/turma-list.html',
            ...
            templateUrl: '/src/entities/turma/views/turma-details.html',
            ...
            templateUrl: '/src/entities/turma/views/turma-create.html',
